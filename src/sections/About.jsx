...
const About = () => {
  const text = `passionate about building fast, intuitive digital experiences,
...
🧪 Prototype fast, test hard, iterate smart—scaling with purpose.
🧗 Rock climbing (problem-solving with real stakes)
🔁 Love pairing sessions, hackathons, and late-night brainstorms—collaboration over ego;`
